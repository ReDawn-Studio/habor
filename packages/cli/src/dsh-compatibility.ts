// Required peer dependency closure of the verified official DSH 0.1.0-rc.8 runtime (2026-09-14).
// Declaring these explicitly avoids npm's cyclic peer solver without omitting runtime dependencies.
export const DSH_COMPATIBLE_PEERS: Record<string, string> = {
